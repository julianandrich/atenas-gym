...
? 'block px-4 py-2 items-center text-center border-b-2 border-red-700 text-base font-medium leading-5 text-red-700
focus:outline-none focus:border-red-900 transition duration-150 ease-in-out'
: 'block px-4 py-2 items-center text-center border-b-2 border-transparent text-base font-medium leading-5
text-gray-700
